...
class GoogleAuthService:
    def __init__(self, session: Session, oauth_client_id: str | None = None) -> None:
        self.session = session
        self.oauth_client_id = oauth_client_id

    def verify_id_token(self, id_token: str) -> dict[str, str]:
        """Verify Google ID token and return normalized claims used by this app."""
        ...
        claims = google_id_token.verify_oauth2_token(id_token, GoogleRequest(), self.oauth_client_id)
    ...
    def upsert_user(self, claims: dict[str, str]) -> AuthUser:
